package com.sopan.circle_menu.design;

/**
 * Created by supan on 7/2/2018.
 */
...
public class CircleMenu extends View {
    ...
    public CircleMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.partSize = this.dip2px(25.0F);
       // this.partSize = this.dip2px(35.0F);
       // this.iconSize = this.partSize * 4 / 5;
        this.iconSize = this.partSize * 4 / 3;
        this.circleMenuRadius = (float)(this.partSize * 3);
        //this.circleMenuRadius = (float)(this.partSize * 2);
        this.shadowRadius = 5;
        this.status = 16;
        this.init();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int measureSize = this.partSize * 5 * 2;
        this.setMeasuredDimension(measureSize, measureSize);
    }
    ...
    private void drawMenuShadow(Canvas canvas, int centerX, int centerY, float radius) {
        if(radius + 5.0F > 0.0F) {
            this.sPaint.setShader(new RadialGradient((float)centerX, (float)centerY, radius + 5.0F, -16777216, 0, TileMode.CLAMP));
